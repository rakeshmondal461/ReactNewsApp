...
export default function NewsCategorySorted(props) {
				...
				<div className="container paddding">
					<div className="row mx-0">
						<div className="col-md-8 animate-box" data-animate-effect="fadeInLeft">
							{
								...
								<div>
									<div>
										<div className="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">Tech News</div>
									</div>
						...
						<div className="col-md-3 animate-box" data-animate-effect="fadeInRight">
							...
							{props.mpopularNews.data.articles.reduce((result, current, i) => {
								if (i > 0 && i < 6) {
									result.push(
